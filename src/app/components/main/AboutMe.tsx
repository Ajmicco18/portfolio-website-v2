    ...
    return (
        <>
            <Box w={"80%"} margin={"auto"} padding={8}>
                <Heading size={"3xl"} fontSize="48px" color={"white"} padding={3} textDecoration={"underline"} textDecorationColor={"#2D42B9"}>About Me</Heading>
                <Text as={"p"} padding={3} color={"white"}>I am Anthony Micco, I am an undergraduate Computer Science student at Youngstown State University. I am going into my
